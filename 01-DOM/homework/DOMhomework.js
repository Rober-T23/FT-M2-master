...
function buildToDo(toDo, index) {
  ...
  //SetAtribute("class/id","name-id/class")
...
function displayToDos() {
  // Tu código acá:
 var toDoContaine = document.getElementById('toDoContainer');
 toDoContaine.innerHTML="";
 var datos= buildToDos(toDoItems)
 for (var i = 0; i < datos.length; i++) {
  toDoContaine.appendChild(datos[i]);
